...
The current state of adolescent sex education in the United States is criticized for being fragmented and inadequate, susceptible to political influence, and lacking comprehensive information. Only a small number of states require contraception education, and even fewer cover important topics like gender diversity and consent. This limited focus hampers the effectiveness of sex education programs, as highlighted by the American Academy of Pediatrics. Meanwhile, TikTok, a widely popular app among adolescents and youth, provides a platform for "virtual sex education" videos that offer a convenient, private, and inclusive space for sexual health information. However, these videos often face removal and shadow banning due to vague community guidelines regarding nudity and sexual content. Creators, especially those from marginalized communities, are disproportionately targeted by mass reporting. The project's goal is to develop a better system for distinguishing between sexual content and sex education, creating a dataset and establishing a strong baseline for future research.
